...
def get_SST_dataset(SST_dir_path, ZuCo_used_sentences, ZUCO_SENTIMENT_LABELS):
    ...
    with open('/shared/nas/data/m1/wangz3/SAO_project/SAO/dataset/stanfordsentiment/stanfordSentimentTreebank/ternary_dataset.json', 'w') as out:
        json.dump(filtered_ternary_dataset,out, indent = 4)
    print('write json to /shared/nas/data/m1/wangz3/SAO_project/SAO/dataset/stanfordsentiment/stanfordSentimentTreebank/ternary_dataset.json')

if __name__ == '__main__':
    SST_dir_path = '/shared/nas/data/m1/wangz3/SAO_project/SAO/dataset/stanfordsentiment/stanfordSentimentTreebank'
    ZuCo_task1_csv_path = '/shared/nas/data/m1/wangz3/SAO_project/SAO/dataset/ZuCo/task_materials/sentiment_labels_task1.csv'
