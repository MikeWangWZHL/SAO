...
rootdir = "/shared/nas/data/m1/wangz3/SAO_project/SAO/dataset/ZuCo/task2-NR-2.0/Matlab_files/"
...
output_name = f'{task_name}-dataset-with-tokens_7-15.pickle'
...
print(len(dataset_dict['YAC']))
print(dataset_dict['YAC'][0].keys())