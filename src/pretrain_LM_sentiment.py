...
def train_model_SST(dataloaders, device, model, criterion, optimizer, scheduler, num_epochs=25, checkpoint_path_best = '/shared/nas/data/m1/wangz3/SAO_project/SAO/checkpoints_pretrained/best/test.pt', checkpoint_path_last = '/shared/nas/data/m1/wangz3/SAO_project/SAO/checkpoints_pretrained/last/test.pt'):
    # modified from: https://pytorch.org/tutorials/beginner/transfer_learning_tutorial.html
    since = time.time()
...
if __name__ == '__main__':
    ...
    if dataset_name == 'ZuCo':
        ...
        save_name = f'On_StanfordSentitmentTreeband_{model_name}_b{batch_size}_{num_epochs_step1}_{step1_lr}_7-19'
    ...
    if dataset_name == 'ZuCo':
        ...
        model = train_model_SST(dataloaders, device, model, criterion, optimizer_step1, exp_lr_scheduler_step1, num_epochs=num_epochs_step1, checkpoint_path_best = output_checkpoint_name_best, checkpoint_path_last = output_checkpoint_name_last)
