...
def get_input_sample(sent_obj, tokenizer, eeg_type = 'TRT', bands = ['_t1','_t2','_a1','_a2','_b1','_b2','_g1','_g2'], max_len = 48, add_CLS_token = False):
...
class ZuCo_dataset(Dataset):
    def __init__(self, input_dataset_dict, phase, tokenizer, subject = 'ALL', eeg_type = 'TRT', bands = ['_t1','_t2','_a1','_a2','_b1','_b2','_g1','_g2'], setting = 'unique_sent', is_add_CLS_token = False):
        self.inputs = []
